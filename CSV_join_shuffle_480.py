...
spark = SparkSession.builder.master("local[*]").appName("CSV_join_shuffle_480").getOrCreate()

#%% ustawienie parametrow Sparka
...
df_wielki=spark.read.options(header='true',delimiter=',', inferSchema='true')\
    .csv("/home/ubuntu/spark-3.0.1-bin-hadoop2.7/source_ALL")
